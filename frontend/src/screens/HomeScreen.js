                ...
                <div className="container items-center max-w-6xl px-8 mx-auto xl:px-5">
                    ...
                    <div className="w-full md:w-1/2 md:px-3">
                        ...
                        <div className="relative flex flex-col sm:flex-row sm:space-x-4">
                            <a href="#_" className="flex items-center w-full px-6 py-3 mb-3 text-lg text-white bg-yellow-400 rounded-md sm:mb-0 hover:bg-yellow-500 sm:w-auto">
                            Try It Free
                ...
                <div className="box-border flex flex-col items-center content-center px-8 mx-auto mt-2 leading-6 text-black border-0 border-gray-300 border-solid md:mt-20 xl:mt-0 md:flex-row max-w-7xl lg:px-16">
                    ...
                    <div className="box-border w-full text-black border-solid md:w-1/2 md:pl-6 xl:pl-32">
                        ...
                        <ul className="p-0 m-0 leading-6 border-0 border-gray-300">
                            ...
                            <li className="box-border relative py-1 pl-0 text-left text-gray-500 border-solid">
                                <span className="inline-flex items-center justify-center w-6 h-6 mr-2 text-white bg-yellow-300 rounded-full"><span className="text-sm font-bold">✓</span></span> Obtain detailed analytical reports
                            </li>
                        </ul>
                    </div>
